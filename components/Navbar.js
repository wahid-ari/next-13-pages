  ...
  return (
    <nav className="py-4 max-w-5xl px-4 mx-auto flex flex-wrap gap-3 justify-between sticky top-0 z-10 bg-white dark:bg-neutral-900">
      <div className="flex items-center gap-x-5 gap-y-3">
        ...
        <Link href="/ssr" className="text-sky-500 hover:text-sky-600 transition-all text-sm font-medium">
          SSR
        </Link>
        <Link href="/csr" className="text-sky-500 hover:text-sky-600 transition-all text-sm font-medium">
          CSR
        </Link>
        <Link href="/image" className="text-sky-500 hover:text-sky-600 transition-all text-sm font-medium">
          next/image
        </Link>
        ...
        <Link href="/tailwind" className="text-sky-500 hover:text-sky-600 transition-all text-sm font-medium">
          Tailwind
        </Link>
      </div>
